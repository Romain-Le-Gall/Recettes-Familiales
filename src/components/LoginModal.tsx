...
export default function LoginModal() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-slate-900/30 via-slate-700/20 to-slate-900/30 backdrop-blur-sm p-4">
      <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-lg border border-slate-200">
        <h2 className="mb-1 text-center text-2xl font-semibold text-slate-800">Connexion familiale</h2>
